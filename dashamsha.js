          ...
          <tbody>
            ${d10.d10Planets.map(p => {
              ...
              return `<tr>
                ...
                <td>H${p.d10House} &mdash; <em style="color:rgba(232,220,200,0.6)">${HOUSE_THEME[p.d10House-1]}</em></td>
                <td class="${dc}">${p.d10Dignity || 'neutral'}</td>
                <td style="font-size:0.83rem;color:rgba(232,220,200,0.72)">${CAREER_THEME[p.planet]}</td>
              </tr>`;
            }).join('')}
          </tbody>
        </table>
